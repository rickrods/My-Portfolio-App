...
This is a Next.js 16.2.10 portfolio website that automatically displays GitHub repository information, Vercel deployment details, and user profile data. It uses the GitHub API and Vercel API to gather project data for a personal portfolio.
...
This portfolio prioritizes simplicity and GitHub integration over complex build tooling or testing infrastructure. Focus on content and configuration rather than development workflow when making changes.